...
module.exports.testSplit = async (req, res) => {
  ...
  _async.forEachOf(queryResponse.rows, (card, key, cardsCallback) => {
...
module.exports.createAgencyFromDB = async (req, res) => {
  ...
  const users = await client.query('SELECT * FROM core_user where is_superuser = false and is_active = true  and id = 381 order by first_name asc limit 5');
